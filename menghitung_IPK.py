...
English             = float(input("Masikan Nilai English Anda :"))
...
total_english = sks_english * nilaiToBobot(English)

total_sks =sks_algoritma + sks_objek + sks_etika + sks_kalkulus + sks_database + sks_english

IPK = (total_algoritma + total_objek + total_etika + total_kalkulus + total_database + total_english) / total_sks
